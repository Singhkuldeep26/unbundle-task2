...
$('.ctm_checkbox_btn .checkbox :checkbox').on('click',function(e) {
   var value = $(this).data('value'); 
   if($(this).prop('checked')){
     $(this).closest('.variant_wrapper').find('variant-radios .product-form__input :radio[value="'+value+'"]').next('label')[0].click();  
   }else{
     $(this).closest('.variant_wrapper').find('variant-radios .product-form__input .value_wrapper:nth-child(2) label')[0].click();    
   } 
})