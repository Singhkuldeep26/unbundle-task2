...
Line 41:11 Transforming const to the configured target environment ("es5") is not supported yet
Line 41:22 Transforming for-of loops to the configured target environment ("es5") is not supported yet
Line 42:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 54:11 Transforming const to the configured target environment ("es5") is not supported yet
Line 54:21 Transforming for-of loops to the configured target environment ("es5") is not supported yet
Line 66:11 Transforming const to the configured target environment ("es5") is not supported yet
Line 66:21 Transforming for-of loops to the configured target environment ("es5") is not supported yet
Line 80:4 Transforming let to the configured target environment ("es5") is not supported yet
